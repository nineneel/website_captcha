...
<body>
    ...
    <main class="w-100">
        <div class="container">
            <h1 class="bg-danger text-light text-center py-3">All User List</h1>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($users as $user) { ?>
                            <tr>
                                ...
                                <td><?= $user['password'] ?></td>
                                <td><?= $user['role'] ?></td>
                                <td><a href="delete.php?id=<?= $user["user_id"] ?>" class="badge text-bg-danger text-decoration-none">delete</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                    </table>
